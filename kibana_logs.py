"""
This python script IS a ROUGH DRAFT to showcase the use case of kibana logs
"""
...
def search():
    ...
    for i in range(2):
	    result_a = results['hits']['hits'][i]['_source']['']
	    result_b = results['hits']['hits'][i]['_source']['']
	    result_c = results['hits']['hits'][i]['_source']['']
	    result_x = results['hits']['hits'][i]['_source']['']
